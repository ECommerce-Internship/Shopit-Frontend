...
export async function getAllReviews(page: number = 1, pageSize: number = 10, filters: ReviewFilters = {}): Promise<ProductReviews> {
...
export async function fetchModerationQueue(page: number = 1, pageSize: number = 10, filters: ReviewFilters = {}): Promise<ProductReviews> {
