...
const updateQtyMutation = useMutation({
  mutationFn: async ({ cartItemId, quantity }: { cartItemId: number; quantity: number }): Promise<Cart | void> =>
  quantity === 0 ? removeCartItem(cartItemId) : updateCartItem(cartItemId, quantity),
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 flex flex-col gap-4">
            {items.map((item) => {
              const isPendingInc = pendingQty[item.productId] === 'inc' && updateQtyMutation.isPending;
              const isPendingDec = pendingQty[item.productId] === 'dec' && updateQtyMutation.isPending;
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      value={item.quantity}
                      readOnly
                      className="w-10 text-center text-sm rounded"
                  ...
                  {/* Line total */}
                  <p className="text-sm font-medium w-20 text-right" style={inkText}>
                  ...
                  >
                    {isRemoving ? (
                      <Loader2 size={16} className="animate-spin" color="#8A8273" />
                    ) : (
              ...
              {cart?.couponCode ? (
                <div className="flex items-center gap-2">
                  <span
                    ...
                    style={{ backgroundColor: '#E3EEE6', color: '#2F6F4F', fontFamily: "'IBM Plex Mono', monospace", fontSize: '12px' }}
                  >
                  ...
                  <button
                    ...
                    style={{ color: '#B14A2D', fontFamily: "'Inter', sans-serif" }}
                  >
